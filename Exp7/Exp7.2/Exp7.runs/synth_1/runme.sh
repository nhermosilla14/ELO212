...
HD_PWD='/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp7/Exp7.2/Exp7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SE_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SE_top.tcl
