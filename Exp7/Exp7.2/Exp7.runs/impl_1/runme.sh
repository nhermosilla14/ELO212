...
HD_PWD='/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp7/Exp7.2/Exp7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SE_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SE_top.tcl -notrace
