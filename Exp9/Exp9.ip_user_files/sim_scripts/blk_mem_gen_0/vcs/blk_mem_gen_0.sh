...
#
# Generated by Vivado on Fri Aug 24 15:42:30 -03 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"/home/nicolas/.local/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_1 $vlogan_opts +v2k +incdir+"/home/nicolas/.local/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/home/nicolas/.local/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
