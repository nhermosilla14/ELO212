...
#
# Generated by Vivado on Tue Aug 21 15:58:55 -03 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"/home/nicolas/.local/opt/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_1 $vlogan_opts +v2k +incdir+"/home/nicolas/.local/opt/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/home/nicolas/.local/opt/Xilinx/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../../Exp9.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp9/Exp9.cache/compile_simlib/vcs"
  fi
