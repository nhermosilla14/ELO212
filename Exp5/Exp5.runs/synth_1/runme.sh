...
HD_PWD='/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp5/Exp5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_calc5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source base_calc5.tcl
