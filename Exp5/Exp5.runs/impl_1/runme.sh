...
HD_PWD='/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp5/Exp5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log base_calc5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source base_calc5.tcl -notrace
