...
HD_PWD='/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp6-3.5/Exp6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log calculadora_retentor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source calculadora_retentor.tcl -notrace
