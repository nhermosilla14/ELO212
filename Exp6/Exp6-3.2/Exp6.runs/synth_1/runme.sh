...
HD_PWD='/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp6-3.2/Exp6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_rgb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_rgb.tcl
