...
HD_PWD='/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp6-3.2/Exp6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log control_rgb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source control_rgb.tcl -notrace
