...
HD_PWD='/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp9-reloj/Exp9-reloj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Exp9reloj.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Exp9reloj.tcl
