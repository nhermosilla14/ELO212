...
HD_PWD='/home/nicolas/Documentos/ELO/Digitales/LAB/Verilog/Exp9-reloj/Exp9-reloj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Exp9reloj.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Exp9reloj.tcl -notrace
